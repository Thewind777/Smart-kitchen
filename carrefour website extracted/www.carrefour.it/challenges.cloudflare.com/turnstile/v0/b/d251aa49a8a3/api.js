            ...
            if (a.source === U) {
                ...
                if (!(!a.widgetId || !g.widgetMap.has(a.widgetId))) {
                    ...
                    if (!(!i || !n)) switch (a.event) {
                        case "init":
                            {
                                var l;n.widgetInitStartTimeTsMs = j(),
                                n.kills = a.kills;
                                var s = n.shadow.getElementById(i);s || m("Cannot initialize Widget, Element not found (#".concat(i, ")."), 3074),
                                n.mode = a.mode,
                                n.nextRcV = a.nextRcV,
                                n.mode === z.Invisible && n.params["refresh-expired"] === Z.Manual && b("refresh-expired=manual is impossible in invisible mode, consider using '".concat(Z.Auto, "' or '").concat(Z.Never, ".'")),
                                n.mode !== z.Managed && n.params["refresh-timeout"] !== ce.Auto && b("setting refresh-timeout has no effect on an invisible/non-interactive widget and will be ignored."),
                                n.params.appearance === $.Always || n.isExecuting && n.params.appearance === $.Execute ? Ft(s, n) : Ar(s),
                                s.style.display = "";
                                var y = n.shadow.querySelector("#".concat(i));y || m("Received state for an unknown widget: ".concat(a.widgetId), 3078),
                        ...
                        case "translationInit":
                            {
                                var x = n.shadow.getElementById(i);x || m("Cannot initialize Widget, Element not found (#".concat(i, ")."), 3074);
                                var T = new Map;n.displayLanguage = a.displayLanguage,
                                Object.keys(a.translationData).forEach(function(Q) {
                        ...
                        case "requestFeedbackData":
                            {
                                var re, de = n.shadow.querySelector("#".concat(i));de || m("Received state for an unknown widget: #".concat(i, " / ").concat(a.widgetId), 3078),
                                (re = de.contentWindow) === null || re === void 0 || re.postMessage({
                        ...
                        case "turnstileResults":
                            {
                                var xe, q, fe = (xe = n.wrapper.parentNode) === null || xe === void 0 ? void 0 : xe.querySelector("#".concat(i, "-fr"));fe || m("Received state for an unknown widget: ".concat(a.widgetId), 3078),
                                (q = fe.contentWindow) === null || q === void 0 || q.postMessage({
                                    cfChlOut: n.cfChlOut,
                        ...
                        case "closeFeedbackReportIframe":
                            {
                                var ne, we = (ne = n.wrapper.parentNode) === null || ne === void 0 ? void 0 : ne.querySelector("#".concat(i, "-fr"));we || m("Received state for an unknown widget: ".concat(a.widgetId), 3078),
                                gr("".concat(i, "-fr"));
                                break
                            }
                        case "tokenExpired":
                            {
                                var ae, Ee = a.token;n.isExpired = !0,
                                (ae = n.cbExpired) === null || ae === void 0 || ae.call(n, Ee),
                                n.params["refresh-expired"] === Z.Auto && !n.isResetting && w(H.AutoExpire, i);
                                break
                            }
                        ...
                        case "reloadRequest":
                            {
                                c(n, a.nextRcV, a.widgetId),
                                w(a.trigger, i);
                                break
                            }
                        case "interactiveBegin":
                            {
                                var Te, Ne = n.shadow.getElementById(i);Ne || m("Cannot layout widget, Element not found (#".concat(i, ")."), 3076),
                                (Te = n.cbBeforeInteractive) === null || Te === void 0 || Te.call(n),
                                n.params.appearance === $.InteractionOnly && Ft(Ne, n);
                                break
                            }
                        case "interactiveEnd":
                            {
                        ...
                        case "requestExtraParams":
                            {
                                var Re;n.widgetParamsStartTimeTsMs = j();
                                var Ae = n.shadow.querySelector("#".concat(i));Ae || m("Received state for an unknown widget: ".concat(a.widgetId), 3078),
                                n.isResetting = !1;
                                var oe = {},
                                    et = j(),
                                    Ie = {
