...
(function(l) {
    ...
    d.prototype.onButtonStatusChange = function() {
        ...
        a && (this.isButtonDisabled ? (a.onclick = function() {}, a.classList.remove("helpButtonEnabled"), a.classList.add("helpButtonDisabled"), a.setAttribute("aria-disabled", "true")) :
            (a.onclick = this.onHelpButtonClick.bind(this), a.classList.remove("helpButtonDisabled"), a.classList.add("helpButtonEnabled"), a.removeAttribute("aria-disabled")), a = a.querySelector(".message")) && (a.innerHTML = this.isButtonDisabled ? this.settings.disabledMinimizedText : this.settings.defaultMinimizedText)
    };
    ...
    d.prototype.registerLinkAction =
        function(a, b) {
    ...
    d.prototype.setLinkAction = function(a, b, c) {
        ...
        e ? (this.settings.linkAction.feature =
            e, this.settings.linkAction.name = this.validLinkActions[e].filter(function(f) {
    ...
    d.prototype.getLinkActionData = function() {
        window.location.search.replace(/([a-zA-Z0-9._]+)=([^&\s]+)/g, function(a, b, c) {
            a = b.toLowerCase();
            0 === a.indexOf("snapins.") && (a = a.replace("snapins.", ""), "action" === a ? (c = c.split("."), 2 === c.length && (this.settings.linkAction.feature =
                c[0], this.settings.linkAction.name = c[1])) : this.settings.linkActionParameters[a.toLowerCase()] = c)
        }.bind(this))
    };
    d.prototype.requireAuthentication = function() {
        ...
        if (!this.settings.useCustomAuthentication) {
            if (!this.settings.loginClientId ||
                !this.settings.loginRedirectURL || !this.settings.loginTargetQuerySelector) throw Error("Authentication in Snap-ins requires these valid settings params: loginClientId, loginRedirectURL, loginTargetQuerySelector.");
            ...
            this.addMetaTag("salesforce-client-id",
            ...
            embedded_svc.utils.addEventHandler("requireauth", function() {
                var e = setInterval(function() {
                    window.SFIDWidget && (clearInterval(e), window.SFIDWidget.openid_response ?
                        window.__snapinsLoginCallback() : window.SFIDWidget.login())
                }, 100)
            });
            ...
            window.__snapinsLoginCallback = function() {
                ...
                if (this.loginButtonPressed ||
                    this.componentInitInProgress) e.innerHTML = "";
