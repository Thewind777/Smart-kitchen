/* clarity-js v0.8.49: https://github.com/microsoft/clarity (License: MIT) */ ! function() {
    "use strict";
    var t = Object.freeze({
            __proto__: null,
            get add() {
    ...
    function V(t, e, n) {
        return window.setTimeout(jo(t), e, n)
    }
        ...
        try {
            for (var t in St) {
                ...
                if ("" == Et[e] || document.querySelector(Et[e])) {
                    ...
                    for (var v in h) {
                        var g = parseInt(v);
                        xt(e, g, er(h[g]).trim().slice(0, 1e4))
                    }
                }
            }
            wt.size > 0 && Yi(40)
    ...
    function Gt(t) {
        ...
        if (e) {
            var n = e.value,
                a = n && n.length >= 5 && c.fraud && -1 === "password,secret,pass,social,ssn,code,hidden".indexOf(e.type) ? p(n, 28) : "";
            Kt.push({
                time: f(t),
                event: 42,
                data: {
    ...
    function Ae(t) {
        ...
        if (a) {
            ...
            if (null === t && 0 === i && 0 === o || null === i || null === o) return Pe = h, void(Re = p);
            var m = De.length,
                y = m > 1 ? De[m - 2] : null;
            y && function(t, e) {
                var n = t.data.x - e.data.x,
            ...
            }(y, g) && De.pop(), De.push(g), B(je), je = V(Le, 500, 10)
        }
    }
    var Ye = Te(Ae, 25);
    ...
    var un = Object.freeze({
        ...
        observe: on,
        start: function() {
            Nr = [], xr(), ie(), ce(), Ee(), he(), Ne = !1, Yo(window, "resize", Me), xe(), Yo(document, "visibilitychange", en), en(), Yo(window, "focus", (function() {
                return rn(1)
            })), Yo(window, "blur", (function() {
                return rn(0)
            })), De = [], Ae(), Ve(), Zt(), Qe(), Yo(window, "pagehide", $e)
        },
        stop: function() {
            Nr = [], xr(), ie(), ce(), B(ge), ve.length > 0 && Oe(ve[ve.length - 1].event), B(se), he(), Ce(), nn(), an(), B(je), Ye.cleanup(), De = [], Pe = null, Re = null, Ve(), B(qe), Zt(), Qe(), tn()
        }
    });
    ...
    function yn(t, e) {
        if ((!c.lean || !c.lite) && (-1 === pn.indexOf(t) && (pn.push(t), t.defaultView && gn(t.defaultView)), e = e || f(), null == t ? void 0 : t.adoptedStyleSheets)) {
            ...
            fn[o] || (fn[o] = []),
                ...
                }(e, t == document ? -1 : Va(t), 3, n), fn[o] = n, hn[o] = e)
        }
    }
    ...
    function Xn(t) {
        Yn.has(t) || (Yn.add(t), An.push(t), Si(zn.bind(this, 51)))
    }
            ...
            return ot(this, (function(z) {
                switch (z.label) {
                    case 0:
                        ...
                        return [3, 13];
                    case 1:
                        return i = jn, r.push(i.width), r.push(i.height), D(t, i.width, i.height), ei(r), [3, 13];
                    case 2:
                    ...
                    case 3:
                        ...
                        for (h = 0, p = sn; h < p.length; h++) m = p[h], (r = [m.time, m.event]).push(m.data.id), r.push(m.data.operation), r.push(m.data.cssRules), ei(r, !1);
                        return bn(), [3, 13];
                    case 4:
                    ...
                    case 8:
                        ...
                        for (E = k.data, T = k.metadata.active, _ = k.metadata.suspend, N = k.metadata.privacy, M = function(t) {
                            ...
                            if (E[C = I[x]] || "" === E[C]) switch (C) {
                                case "tag":
                                    R = Wn(k), j = M ? -1 : 1, r.push(k.id * j), k.parent && T && (r.push(k.parent), k.previous && r.push(k.previous)), r.push(_ ? "*M" : E[C]), R && 2 === R.length && r.push("".concat("#").concat(Hn(R[0]), ".").concat(Hn(R[1])));
                                    break;
                                case "attributes":
                                    for (A in E[C]) void 0 !== E[C][A] && r.push(qn(A, E[C][A], N));
                                    break;
                                case "value":
                    ...
                    case 11:
                        return [3, 13];
                    case 12:
                        for (Y = 0, X = An; Y < X.length; Y++) L = X[Y], ei([a, 51, L]);
                        return Ln(), [3, 13];
                    case 13:
                        return [2]
                }
    ...
    function Fn() {
        ...
        null !== jn && c === jn.width && v === jn.height || null === c || null === v || (jn = {
            width: c,
            height: v
        }, zn(8))
    }
        ...
        for (var e = 0, n = Object.keys(t); e < n.length; e++) {
            ...
            if ("@type" === a && "string" == typeof r) switch (r = (r = r.toLowerCase()).indexOf("article") >= 0 || r.indexOf("posting") >= 0 ? "article" : r) {
                ...
                case "aggregaterating":
                    t.ratingValue && (F(11, pa(t.ratingValue, 100)), F(18, pa(t.bestRating)), F(19, pa(t.worstRating))), F(12, pa(t.ratingCount)), F(17, pa(t.reviewCount));
                    break;
                case "offer":
                    Ji(7, t.availability), Ji(14, t.itemCondition), Ji(13, t.priceCurrency), Ji(12, t.sku), F(13, pa(t.price));
                    break;
                case "brand":
                    Ji(6, t.name)
            }
        ...
        or(t) || zo(t) || (! function(t) {
            try {
                var e = s("MutationObserver"),
                    n = e in window ? new window[e](jo(ra)) : null;
                n && (n.observe(t, {
                    attributes: !0,
                    childList: !0,
                    characterData: !0,
    ...
    function Sa(t) {
        ...
        try {
            ...
            if (hi(1, 1, t ? t.name : null), t && "SecurityError" !== t.name) throw t
        }
        if (null !== n)
    ...
    function Ua() {
        _a = 1, Ma = [], xa = [], Ia = {}, Ca = [], Da = [], Pa = "address,password,contact".split(","), Ra = "password,secret,pass,social,ssn,code,hidden".split(","), ja = "radio,checkbox,range,button,reset,submit".split(","), Aa = "INPUT,SELECT,TEXTAREA".split(","), Na = new Map, Ya = new WeakMap, Xa = new WeakMap, La = new WeakMap, za = new WeakMap, Wa = new WeakMap, Oa = {}
    }
                ...
                function(t, e, n) {
                    ...
                    switch (!0) {
                        case Aa.indexOf(c) >= 0:
                            ...
                            i.privacy = "INPUT" === c && ja.indexOf(s) >= 0 ? o : f ? 4 : 2;
                            break;
                        ...
                        case "*T" === c:
                            ...
                            i.privacy = v.includes(h) || Ca.some((function(t) {
    ...
    function br() {
        for (var t = [], e = 0, n = pr; e < n.length; e++) {
            var a = n[e],
                r = Va(a.node);
            r ? (a.state.data.id = r, hr[r] = a.state.data, dr.push(a.state)) : t.push(a)
        }
        pr = t, dr.length > 0 && zn(7)
    }
    ...
    function Sr(t, e, n, a) {
        ...
        e.interaction = n > e.interaction ? n : e.interaction, e.visibility = a > e.visibility ? a : e.visibility, e.id ? (e.id in hr && r || !(e.id in hr)) && (hr[e.id] = e, dr.push(kr(e))) : pr.push({
            node: t,
            state: kr(e)
        })
    }
            ...
            return ot(this, (function(q) {
                switch (n = e || f(), a = [n, t], t) {
                    ...
                    case 48:
                        ...
                        break;
                    case 38:
                        for (d = 0, h = oe; d < h.length; d++) z = h[d], a = [z.time, z.event], (Y = Tr(z.data.target, z.event)).id > 0 && (a.push(Y.id), a.push(z.data.action), ei(a));
                        ce();
                        break;
                    case 11:
                        p = pe, a.push(p.width), a.push(p.height), D(t, p.width, p.height), Ce(), ei(a);
                        break;
                    case 26:
                    ...
                    case 21:
                        ...
                        break;
                    case 10:
                        for (E = 0, T = De; E < T.length; E++) z = T[E], _ = Tr(z.data.target, z.event), N = Tr(z.data.top, z.event), M = Tr(z.data.bottom, z.event), x = (null == N ? void 0 : N.hash) ? N.hash.join(".") : "", I = (null == M ? void 0 : M.hash) ? M.hash.join(".") : "", _.id > 0 && ((a = [z.time, z.event]).push(_.id), a.push(z.data.x), a.push(z.data.y), a.push(x), a.push(I), a.push(z.data.trust), ei(a), D(z.event, z.data.x, z.data.y, z.time));
                        De = [], Pe = null, Re = null;
                        break;
                    case 42:
                        ...
                        break;
                    case 39:
                        for (j = 0, A = Ge; j < A.length; j++) z = A[j], a = [z.time, z.event], (Y = Tr(z.data.target, z.event)).id > 0 && (a.push(Y.id), ei(a));
                        Qe();
                        break;
                    case 22:
            ...
            function(t) {
                it(this, void 0, void 0, (function() {
                    ...
                    return ot(this, (function(v) {
                        switch (e = f(), n = [e, t], t) {
                            case 8:
                                a = jn, n.push(a.width), n.push(a.height), D(t, a.width, a.height), ei(n);
                                break;
                            case 43:
                                if ((r = Dr).length > 0) {
                                        ...
                                        for (u = o[i], c = u.metadata.privacy, s = u.data, l = 0, d = ["tag", "attributes", "value"]; l < d.length; l++)
                                            if (s[h = d[l]]) switch (h) {
                                                case "tag":
                                                    ...
                                                    break;
                                                case "attributes":
                                                    for (p in s[h]) void 0 !== s[h][p] && n.push(Cr(p, s[h][p], c));
                                                    break;
                                                case "value":
    ...
    var qr, Ur, Fr, Vr, Br, Jr = Object.freeze({
            ...
            register: Wr,
            start: function() {
                Lr = !0, zr = new Set, c.modules && c.modules.length > 0 && c.modules.forEach((function(t) {
                    Hr(t)
                }))
            },
            stop: function() {
    ...
    function ei(t, e) {
        if (void 0 === e && (e = !0), Vr) {
            var n = f(),
                ...
                r = JSON.stringify(t);
            switch (c.lean ? !$r && Gr + r.length > 10485760 && (hi(10, 0), $r = !0) : $r = !1, a) {
                case 5:
                    if ($r) break;
                    Kr += r.length;
                case 37:
    ...
    function ki() {
        ...
        t && (mi = t, t.task().then((function() {
            ...
            t.id === go() && (e && hi(0, 1, e.name, e.message, e.stack), mi = null, ki())
        })))
    }
    ...
    function ho() {
        ...
        h && "__symbol__" in h && F(39, 1), navigator && (Ji(9, navigator.language), F(33, navigator.hardwareConcurrency), F(32, navigator.maxTouchPoints), F(34, Math.round(navigator.deviceMemory)), (f = navigator.userAgentData) && f.getHighEntropyValues ? f.getHighEntropyValues(["model", "platform", "platformVersion", "uaFullVersion"]).then((function(t) {
            var e;
    ...
    function jo(t) {
        return function() {
            ...
            U(4, n), n > 30 && (q(7), F(6, n), t.dn && hi(9, 0, "".concat(t.dn, "-").concat(n)))
        }
    }
    var Ao = new Map;

    function Yo(t, e, n, a, r) {
        void 0 === a && (a = !1), void 0 === r && (r = !0), n = jo(n);
        try {
            t[s("addEventListener")](e, n, {
                capture: a,
                passive: r
            }), zo(t) || Ao.set(t, []), Ao.get(t).push({
                event: e,
                listener: n,
                options: {
                    capture: a,
    ...
    var nu = Object.freeze({
        ...
        start: function() {
            var t;
            Un(), Fn(), Or(), gr = null, fr = new WeakMap, hr = {}, pr = [], vr = !!window.IntersectionObserver, Ha(), c.delayDom ? Yo(window, "load", (function() {
                    aa()
                })) : aa(), Ii(), mn(),
                function() {
        ...
        stop: function() {
            Or(), fr = null, hr = {}, pr = [], gr && (gr.disconnect(), gr = null), vr = !1, qa(),
                function() {
                ...
                }(), Un(), fn = {}, hn = {}, pn = [], vn = [], bn(), Cn(), Ln(), Yn.clear()
        }
    });
    var au = null;
    ...
    var ou, uu = 0,
        ...
        pu = function() {
            ...
            var t = Math.min(du.length - 1, Math.floor((hu() - lu) / 50));
            return du[t].latency
        },
        vu = function() {
            lu = hu(), du.length = 0, fu.clear()
        },
        gu = function(t) {
    ...
    function yu() {
        try {
            ou && ou.disconnect(), ou = new PerformanceObserver(jo(bu));
            ...
            for (var e = (!("visibilityState" in document) || "visible" === document.visibilityState), n = 0; n < t.length; n++) {
                ...
                switch (a.entryType) {
                    ...
                    case "first-input":
                        ...
                        break;
                    case "event":
                        e && "PerformanceEventTiming" in window && "interactionId" in PerformanceEventTiming.prototype && (gu(a), Ji(37, pu().toString()));
                        break;
                    case "layout-shift":
    ...
    var ku = [eu, nu, un, Object.freeze({
        ...
        start: function() {
            ru(),
                function() {
                    navigator && navigator.connection && Ji(27, navigator.connection.effectiveType), window.PerformanceObserver && PerformanceObserver.supportedEntryTypes ? "complete" !== document.readyState ? Yo(window, "load", V.bind(this, yu, 0)) : yu() : hi(3, 0)
                }()
        },
        stop: function() {
    ...
    function Mu() {
        if (void 0 !== _u) {
            ...
            for (_u[Nu] = function(t) {
                ...
                }, _u[Nu].v = h; t.length > 0;) _u[Nu].apply(_u, t.shift())
        }
    }
    Mu()
}();