...
(self.webpackChunkapp_project = self.webpackChunkapp_project || []).push([
    [9082], {
        59082: function(t, e) {
            ...
            function m(t, e) {
                var n = u({}, t, e);
                return e.hasOwnProperty("classes") && (n.classes = u({}, t.classes, e.classes), e.classes.hasOwnProperty("direction") && (n.classes.direction = u({}, t.classes.direction, e.classes.direction))), e.hasOwnProperty("breakpoints") && (n.breakpoints = u({}, t.breakpoints, e.breakpoints)), n
            }
            var g = function() {
                    function t() {
                ...
                y = function() {
                    function t(e) {
                        ...
                        o(this, t), this._c = {}, this._t = [], this._e = new g, this.disabled = !1, this.selector = e, this.settings = m(n, i), this.index = this.settings.startAt
                    }
                    return s(t, [{
                        key: "mount",
                        value: function() {
                            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                            return this._e.emit("mount.before"), f(t) && (this._c = function(t, e, n) {
                                var r = {};
                                for (var o in e) d(e[o]) ? r[o] = e[o](t, r, n) : i();
            ...
            function q(t) {
                return f(t) ? (e = t, Object.keys(e).sort().reduce(function(t, n) {
            ...
            var B = {
                    Html: function(t, e) {
                        var n = {
                            mount: function() {
                                this.root = t.selector, this.track = this.root.querySelector(H), this.slides = Array.prototype.slice.call(this.wrapper.children).filter(function(e) {
                        ...
                        return p(n, "root", {
                            ...
                            set: function(t) {
                                l(t) && (t = document.querySelector(t)), S(t) && (n._r = t)
                            }
                        }), p(n, "track", {
                            get: function() {
                                return n._t
                        ...
                        var r = {
                            set: function(n) {
                                var r = function(t, e, n) {
                                    var r = [C, M, P, L].concat(t._t, [A]);
                                    return {
                                        mutate: function(o) {
                                            for (var s = 0; s < r.length; s++) {
                                                var u = r[s];
                                                d(u) && d(u().modify) ? o = u(t, e, n).modify(o) : i()
                                            }
                                            return o
                                        }
                                    }
                    ...
                    Peek: function(t, e, n) {
                        ...
                        return p(i, "value", {
                            ...
                            set: function(t) {
                                f(t) ? (t.before = c(t.before), t.after = c(t.after)) : t = c(t), i._v = t
                            }
                        }), p(i, "reductor", {
                            get: function() {
                                var e = i.value,
                    ...
                    Run: function(t, e, n) {
                        var i = {
                            ...
                            calculate: function() {
                                var e = this.move,
                                    ...
                                    i = e.steps,
                                    r = e.direction,
                                    o = "number" == typeof c(i) && 0 !== c(i);
                                switch (r) {
                                    case ">":
                                        ">" === i ? t.index = n : this.isEnd() ? t.isType("slider") && !t.settings.rewind || (this._o = !0, t.index = 0) : o ? t.index += Math.min(n - t.index, -c(i)) : t.index++;
                                        break;
                                    case "<":
                                        "<" === i ? t.index = 0 : this.isStart() ? t.isType("slider") && !t.settings.rewind || (this._o = !0, t.index = n) : o ? t.index -= Math.min(t.index, c(i)) : t.index--;
                                        break;
                                    case "=":
                                        t.index = i
                                }
                        ...
                        return p(i, "move", {
                            ...
                            get: function() {
                                ...
                                return t.isType("slider") && "center" !== n.focusAt && n.bound ? i - 1 - (c(n.perView) - 1) + c(n.focusAt) : i - 1
                            }
                        }), p(i, "offset", {
                            get: function() {
                                return this._o
                            ...
                            l = {
                                ...
                                start: function(e) {
                                    if (!u && !t.disabled) {
                                        ...
                                        r = null, o = c(i.pageX), s = c(i.pageY), this.bindSwipeMove(), this.bindSwipeEnd(), n.emit("swipe.start")
                                    }
                                },
                                move: function(i) {
                                    if (!t.disabled) {
                                    ...
                                    if (!t.disabled) {
                                        ...
                                        this.enable(), l > a && f < s.touchAngle ? (s.perTouch && (d = Math.min(d, c(s.perTouch))), e.Direction.is("rtl") && (d = -d), e.Run.make(e.Direction.resolve("<" + d))) : l < -a && f < s.touchAngle ? (s.perTouch && (d = Math.max(d, -c(s.perTouch))), e.Direction.is("rtl") && (d = -d), e.Run.make(e.Direction.resolve(">" + d))) : e.Move.make(), e.Html.root.classList.remove(s.classes.dragging), this.unbindSwipeMove(), this.unbindSwipeEnd(), n.emit("swipe.end")
                                    }
                                },
                                bindSwipeStart: function() {
                                    ...
                                    r.swipeThreshold && i.on(E[0], e.Html.wrapper, function(t) {
                                        n.start(t)
                                    }, a), r.dragThreshold && i.on(E[1], e.Html.wrapper, function(t) {
                                        n.start(t)
                                    }, a)
                                },
                                unbindSwipeStart: function() {
                                    i.off(E[0], e.Html.wrapper, a), i.off(E[1], e.Html.wrapper, a)
                                },
                    ...
                    Breakpoints: function(t, e, n) {
                        ...
                        return u(r, a.match(o)), i.on("resize", window, w(function() {
                            t.settings = m(r, a.match(o))
                ...
                G = function(t) {
                    ...
                    return function(t, e) {
                        ...
                        value: function() {
                            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                            return a(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "mount", this).call(this, u({}, B, t))
                        }
                    }]), e
                }(y);
            e.A = G
