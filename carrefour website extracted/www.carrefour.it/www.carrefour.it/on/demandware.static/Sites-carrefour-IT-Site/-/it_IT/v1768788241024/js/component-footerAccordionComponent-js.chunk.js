        ...
        46814: function(e, t, n) {
            ...
            var m = function(e) {
                ...
                return (0, c.A)(t, e), (0, i.A)(t, [{
                    ...
                    value: function() {
                        var e = this;
                        this.$el.querySelectorAll(this.SELECTORS.triggers).forEach(function(t) {
                            e.$on("click.tabs", function(t) {
                                t.preventDefault();
                                var n = t.currentTarget;
                                n.classList[n.classList.contains(e.CLASSES.active) ? "remove" : "add"](e.CLASSES.active), n.parentElement.querySelectorAll(e.SELECTORS.content).forEach(function(t) {
                                    var n = t.classList.contains(e.CLASSES.visible);
                                    t.classList[n ? "remove" : "add"](e.CLASSES.visible)
                                });
                                var r = n.querySelector(e.SELECTORS.headerBtn);
                                if (r) {
                                    var i = r.getAttribute("aria-expanded");
                                    r.setAttribute("aria-expanded", !i || "false" === i)
                                }
                            }, t)
