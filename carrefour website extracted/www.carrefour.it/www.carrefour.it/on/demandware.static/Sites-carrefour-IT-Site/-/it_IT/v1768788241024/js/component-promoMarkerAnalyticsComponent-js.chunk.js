    ...
    [2543], {
        23732: function(t, e, n) {
            ...
            var l = function(t) {
                function e(t) {
                    var n, r, a, l;
                    return (0, o.A)(this, e), r = this, a = e, l = [t], a = (0, i.A)(a), (n = (0, c.A)(r, u() ? Reflect.construct(a, l || [], (0, i.A)(r).constructor) : a.apply(r, l))).handleClick(), n
                }
                return (0, a.A)(e, t), (0, r.A)(e, [{
                    key: "getLastSegment",
                    value: function(t) {
                        if (t) {
                            var e = t.split("/").filter(Boolean).pop();
                            return e.split(".").slice(0, -1).join(".") || e
                        }
                        return ""
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        this.$on("click.link", function(e) {
                            if (window.dataLayer) {
                                var n = t.getLastSegment(t.$el.href);
