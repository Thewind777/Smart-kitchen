    ...
    dw.__dwAnalytics = function() {
        ...
        function k(w, J) {
            ...
            function E(T, Q, O, S, P, R) {
                ...
                d.cookie = T + "=" + D(Q) + (O ? ";expires=" + N.toGMTString() : "") + ";path=" + (S ? S : "/") + (P ? ";domain=" + P : "") + (R ? ";secure" : "");
            }
            ...
            function r(T, S, R, O) {
                ...
                var P = S;
                for (var Q = 0; Q < R.length; Q++) {
                    var U = (R[Q][0].slice(0, "pid-".length) == "pid-") && (H(R[Q]) + ((Q + 1) < R.length ? H(R[Q + 1]) : 0) + ((Q + 2) < R.length ? H(R[Q + 2]) : 0) + P.length > l);
                    var W = (R[Q][0].slice(0, "pid-".length) != "pid-") && (H(R[Q]) + P.length > l);
                    if (U || W) {
                        V.push(P);
                        P = u(["dwac", O], S);
        ...
        function e(p) {
            var o = g(p);
            if (o) {
                document.cookie = p + "=; path=/; expires=Thu, 01 Jan 1970 00:00:00 GMT;";
            }
            return o;
        }

        function g(o) {
            return decodeURIComponent(document.cookie.replace(new RegExp("(?:(?:^|.*;)\\s*" + encodeURIComponent(o).replace(/[\-\.\+\*]/g, "\\$&") + "\\s*\\=\\s*([^;]*).*$)|^.*$"), "$1").replace(/\+/g, "%20")) || null;
        }
        ...
        function a() {
            if (dw.ac) {
                ...
                if (dw.ac._anact_nohit_tag || dw.ac._anact) {
                    var s = dw.ac._anact_nohit_tag ? dw.ac._anact_nohit_tag : dw.ac._anact;
                    var p = JSON.parse(s);
                    if (p) {
