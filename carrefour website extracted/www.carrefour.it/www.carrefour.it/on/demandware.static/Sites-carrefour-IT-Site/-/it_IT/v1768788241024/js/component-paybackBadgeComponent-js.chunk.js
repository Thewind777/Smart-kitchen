            ...
            var p = function(t) {
                ...
                return (0, c.A)(e, t), (0, o.A)(e, [{
                    ...
                    value: function() {
                        var t, e, n = this,
                            r = s().get("pbPoints");
                        if (null == r || "" == r) null === (t = document.querySelectorAll(this.SELECTORS.cntNoCard)) || void 0 === t || t.forEach(function(t) {
                            return t.classList.replace(n.CLASSES.HIDE, n.CLASSES.SHOW)
                        }), null === (e = document.querySelectorAll(".js-pb-cnt")) || void 0 === e || e.forEach(function(t) {
                            return t.classList.add(n.CLASSES.HIDE)
                        });
                        else if ("1" === r) {
                            var o;
                            this.setPointsDisplay(), null === (o = document.querySelectorAll(".js-pb-cnt-point")) || void 0 === o || o.forEach(function(t) {
                                return t.classList.replace(n.CLASSES.HIDE, n.CLASSES.SHOW)
                            })
                        } else {
                            var u;
                            this.setPointsDisplay(r), null === (u = document.querySelectorAll(".js-pb-cnt-points")) || void 0 === u || u.forEach(function(t) {
                                return t.classList.replace(n.CLASSES.HIDE, n.CLASSES.SHOW)
                            })
                        }
                    }
                    ...
                    value: function(t) {
                        var e, n = this;
                        null === (e = document.querySelectorAll(this.SELECTORS.cntNoCard)) || void 0 === e || e.forEach(function(t) {
                            return t.classList.replace(n.CLASSES.SHOW, n.CLASSES.HIDE)
                        });
                        var r = document.querySelectorAll(this.SELECTORS.paybackPointsValue);
