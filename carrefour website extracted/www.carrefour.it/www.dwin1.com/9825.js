var AWIN = AWIN || {};
AWIN.Tracking = AWIN.Tracking || {}, AWIN.Tracking.metadata = {}, AWIN.sProtocol = "https://", AWIN.iScriptCount = 0, AWIN.Tracking.device9Url = "https://the.sciencebehindecommerce.com/d9core", AWIN.Tracking.flags = {
        allowNewAWCCookie: !0,
    ...
    }(AWIN.Tracking), AWIN.Tracking.aScripts = [], AWIN.Tracking.iMerchantId = 9825, AWIN.enhancedTracking = !0;
try {
                ...
                if (a) {
                    ...
                    for (o = 0; o < s.length; o++)
                        if (g) {
                            ...
                            s[o] in c || (c[s[o]] = {});
                            var l = A[o].split("-");
                            for (d = 0; d < l.length; d++) c[s[o]][l[d]] = ""
                        } else c[s[o]] = {}, c[s[o]].ck = ""
                }
    ...
    AWIN.Tracking.sendDebugEvent('{"severity":"error","source":{"app":"AMT","category":"plugin"},"body":{"advertiserId":9825,"pluginName":"Advanced Click Storage"}}', e)
}
try {
    AWIN.Tracking.JourneyPath = AWIN.Tracking.JourneyPath || {}, AWIN.Tracking.JourneyPath.publisherParameters = ["sv_campaign_id", "sv_affiliate_id", "sv_affiliateId", "zxuserid", "aw_affid", "awinaffid", "AWPID", "awpubid", "sv_campaign", "awpid", "zxuid", "aw_publisherid", "awinpid"], AWIN.Tracking.JourneyPath = function() {
        ...
        function k() {
            try {
                ...
                if (n) AWIN.Tracking.getFlag("allowNewAWCCookie") && (e = function(e, n) {
                    ...
                    if (i)
                        for (var o = 0; o < AWIN.Tracking.googleIdentifiers.length; o++) {
                            var l = AWIN.Tracking.googleIdentifiers[o],
                                k = AWIN.Tracking.Google.getIdentifierFromUrl(l);
                            if (k && AWIN.Tracking.getFlag("allowNew" + l.toUpperCase() + "Cookie")) {
                                e = p(l, k, i, e), a = !0;
                                break
                            }
                        }
                ...
                }(t, e)), AWIN.Tracking.Sale && e && (AWIN.SaleQueryStringBuilder.addParameter("j", e.id), e.id = s.incrementJourneyCounter(e.id), e = u(e, !1)), n || AWIN.Tracking.Sale || !e || (m = e, AWIN.Tracking.setCookie(r, JSON.stringify(m), m.expiration))
            } catch (e) {
                console.log(e)
            }
            var m
    ...
    AWIN.Tracking.sendDebugEvent('{"severity":"error","source":{"app":"AMT","category":"plugin"},"body":{"advertiserId":9825,"pluginName":"Awin Journey Path"}}', e)
}
try {
    AWIN.Tracking.ChromeAttribution = void 0
} catch (e) {
    AWIN.Tracking.sendDebugEvent('{"severity":"error","source":{"app":"AMT","category":"plugin"},"body":{"advertiserId":9825,"pluginName":"Awin Chrome Attribution"}}', e)
}
